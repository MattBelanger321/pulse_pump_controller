...
import UI.Text.StrokeDelayTitleDocument;

public class StrokeDelayTitle extends JTextPane {
	...
	private StrokeDelayTitleDocument doc;

	private Font font;

	public StrokeDelayTitle() {

		doc = new StrokeDelayTitleDocument();
